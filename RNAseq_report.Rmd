...
tagList(
  lapply(seq_along(efit_list), function(i) {
    contrast <- names(efit_list)[i]  # Capture contrast name
    force(contrast)  # Ensures contrast is evaluated
    display_de_summary(efit_list[[i]])  # Directly return the datatable
  })
)
```
